...
function setup() {
	...
	boxes1 = new Box(500, 130, 30, 40);
	boxes2 = new Box(530, 130, 30, 40);
	boxes3 = new Box(560, 130, 30, 40);
	boxes4 = new Box(590, 130, 30, 40);
	boxes5 = new Box(620, 130, 30, 40);
	boxes6 = new Box(650, 130, 30, 40);
	boxes7 = new Box(680, 130, 30, 40);
	boxes8 = new Box(510, 100, 30, 40);
	boxes9 = new Box(540, 100, 30, 40);
	boxes10 = new Box(570, 100, 30, 40);
	boxes11 = new Box(600, 100, 30, 40);
	boxes12 = new Box(630, 100, 30, 40);
	boxes13 = new Box(660, 100, 30, 40);
	boxes14 = new Box(520, 70, 30, 40);
  boxes15 = new Box(550, 70, 30, 40);
  boxes16 = new Box(580, 70, 30, 40);
  boxes17 = new Box(610, 70, 30, 40);
  boxes18 = new Box(640, 70, 30, 40);
